...
.then(() => {
 ...
 .then(storeShops => {
  ...
  for(let i = 0; i < 50; i++){
    ...
    //console.log('pojavljuje li se ovde?')
    }

    //localStorage.setItem('shopIds3', storeIds);
    console.log('sta je problem ovde?')

 })
 .catch((err) => {
   console.log('na 121 prosledjen error:', err)
 })

 console.log('u ovom radi! :)');
